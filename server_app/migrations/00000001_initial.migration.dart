...
class Migration1 extends Migration { 
  ...
  Future upgrade() async {
		...
		database.addColumn("_Vote", SchemaColumn.relationship("feedback", ManagedPropertyType.bigInteger, relatedTableName: "_Feedback", relatedColumnName: "id", rule: DeleteRule.nullify, isNullable: true, isUnique: true));
  }
